...
use App\Rules\UniqueServiceDateRule;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UserPurchaseServiceValidateRequest extends FormRequest
{
    ...
    {
        return [
            'services' => ['required','array', new UniqueServiceDateRule],
    ...
    protected function prepareForValidation(): void
    {
        ...
        is_null($this->services) ?  $this->merge(['services' => []]) : null;
