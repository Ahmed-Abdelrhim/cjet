...
class UserPurchaseScheduleSingleDetailsResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            // Service Requested
            'purchaseable_title' => $this->getPurchaseTitle($this->user_purchase_request->purchaseable, $this->user_purchase_request->purchaseable_type) ?? null,
            // 'price' => 'EGP ' . $this->user_purchase_request->price,
            'price'=>$this->user_purchase_request->purchaseable_type == Service::class ?  $this->user_purchase_request->price .' EGP' : $this->user_purchase_request->price . ' EGP / Month',

            'type' => $this->getServiceType($this->user_purchase_request->purchaseable_type),
            ...
            'user' => $this->user ?? null,
            'user_address' => $this->handleUserAddress($this->user_purchase_request->address) ?? null,
            'car' => $this->user_purchase_request->car ?? null,
