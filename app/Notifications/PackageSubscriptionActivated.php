...
class PackageSubscriptionActivated extends Notification implements ShouldQueue
{
    use Queueable;
    private $title;
...
/**
    ...
    {
        $this->title='custom.action_triggered.package_subscription_activated.notification.title';
        $this->notification='custom.action_triggered.package_subscription_activated.notification.message';
        $this->notification_paramaters=['invoice_reference_number'=>$entity->invoice_reference_number];
        $this->sms='custom.action_triggered.package_subscription_activated.sms.message';
